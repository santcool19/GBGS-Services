...
import com.gbgs.gateway.models.UrlPatternTree;
import com.gbgs.gateway.models.UrlPatternTreeNode;
...
public class AuthorizationFilter extends ZuulFilter {
	...
	public Object run() throws ZuulException {
		...
		Optional<UrlPatternTreeNode> claimNode = Optional.ofNullable(urlPatternTree.verifyIfRequestIsAuthorized(requestURI));
